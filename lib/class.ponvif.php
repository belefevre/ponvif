...
class ponvif
{
    ...
    */
    ...
    public function setDeviceUri($deviceUrl)
    {
        $this->mediaurl = $deviceUrl;
    }
    ...
    */
    ...
    protected function _getOnvifVersion($capabilities)
    {
        ...
        if (isset($capabilities['Device']['System']['SupportedVersions']['Major'])) {
            ...
            $currentma = 0;
            $currentmi = 0;
            if (isset($capabilities['Device'])) {
                if (isset($capabilities['Device']['System'])) {

                    if (count($capabilities['Device']['System']['SupportedVersions']) > 0) {
